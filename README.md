...
#3. Inicialización de la Base de DatosAsegúrate de tener un servicio local de MySQL activo. Luego, importa la estructura y los registros de prueba.Desde la terminal:Bashmysql -u root -p < database/schema.sql# 🛠️ MesaLab — Plataforma Web de Soporte Técnico
